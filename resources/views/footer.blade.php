    ...
    <footer>
        <div class="container text-center">
          <div class="row">
            ...
            <div class="col" id="footer-col">
              <h6>Kontak</h6>
              <img src="{{ asset('assets/whatsapp-footer.png') }}" class="footer-image" alt="footer-whatsapp" width="30" height="30">
              <span><a href="https://wa.me/+6282341497223" target="_blank">+6282341497223</a></span>
              <br>
              <img src="{{ asset('assets/instagram-footer.png') }}" class="footer-image" alt="footer-instagram" width="30" height="30">
