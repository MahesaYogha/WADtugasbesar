...
<body>
    ...
    <center>
        <div class="container">
            ...
            <br>
            <div class="col">
                <form action="createReview.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <br>
                        <textarea type="string" class="form-control" name="review" id="review" rows="5"></textarea>
                    </div>
                    <button type="submit" name="back" id="back" class="btn btn-light"><a href="review.html">Kembali</a></button>
